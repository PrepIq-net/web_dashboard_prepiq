  ...
  return (
    <div className="min-h-screen bg-[#141416] flex items-center justify-center p-6">
      <div className="w-full max-w-lg">
        ...
        {/* Headline */}
        <h1 className="font-display text-[40px] leading-[48px] font-semibold text-[#F5F5F7] mb-3" dangerouslySetInnerHTML={{ __html: t("setup.branchPrompt.title").replace("your first", "your<br />first") }} />
