      ...
      <div className="min-h-screen bg-[#141416] flex items-center justify-center p-6">
        <div className="w-full max-w-2xl flex flex-col items-center justify-center py-20 text-center">
          ...
          <h1 className="font-display text-[28px] leading-[36px] font-semibold text-[#F5F5F7] mb-3">
            {t("setup.forecast.learning")}
          </h1>
          <p className="text-[14px] text-[#8E8E93]">
            {t("setup.forecast.building")}
          </p>
        </div>
      </div>
    );
      ...
      <div className="w-full max-w-6xl mx-auto">
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#A8821F]">
            {t("setup.common.step", { step: 4 })} — {t("setup.common.intelligence")}
          </span>
        </div>

        <h1 className="font-display text-[36px] leading-[44px] font-semibold text-[#F5F5F7] mb-2">
          {t("setup.forecast.firstInsightTitle", { branch: insight.branch_name })}
        </h1>
        <p className="text-[15px] leading-[24px] text-[#A0A0A5] mb-8">
          {t("setup.forecast.insightDescription", { days: insight.lookback_days })}
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-8">
          <div className="lg:col-span-2 rounded-[14px] border border-[#2E2E33] bg-[#1C1C1F] p-5">
            <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#8E8E93] mb-4">
              {t("setup.forecast.yesterdayInsight")}
            </p>
          ...
          <div className="rounded-[14px] border border-[#2E2E33] bg-[#1C1C1F] p-5">
            ...
            <div className="space-y-3">
              ...
              <div>
                <p className="text-[11px] text-[#8E8E93]">{t("setup.forecast.wasteLeakage")}</p>
              ...
              <div>
                <p className="text-[11px] text-[#8E8E93]">{t("setup.forecast.potentialSavings")}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
          <div className="rounded-[14px] border border-[#2E2E33] bg-[#1C1C1F] p-5">
            <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#8E8E93] mb-4">
              {t("setup.forecast.forecastNextWeeks")}
            </p>
            <div className="space-y-3">
              {insight.next_3_weeks_forecast.map((week) => (
                ...
                >
                  <div>
                    <p className="text-[11px] text-[#8E8E93]">{t("setup.forecast.week", { index: week.week_index })}</p>
                  ...
                  <div>
                    <p className="text-[11px] text-[#8E8E93]">{t("setup.forecast.projectedRev")}</p>
          ...
          <div className="rounded-[14px] border border-[#2E2E33] bg-[#1C1C1F] p-5">
            <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#8E8E93] mb-4">
              {t("setup.forecast.topPerformingItems")}
            </p>
            <div className="space-y-3">
                ...
                insight.performance.top_items.map((item) => (
                  ...
                  >
                    ...
                    <p className="text-[12px] text-[#8E8E93] mt-1">
                      {t("setup.forecast.revenue28d", { amount: toCurrency(item.last_28d_revenue) })}
                    </p>
                    <p className="text-[12px] text-[#C7C7CC] mt-1">
                      {t("setup.forecast.qty3weeks", { quantities: item.projected_quantity_next_weeks.join(" / "), unit: item.unit })}
                    </p>
                  </div>
                ))
              ) : (
        ...
        <div className="pt-6 border-t border-[#2E2E33]">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            >
              {t("setup.forecast.continueToTeam")}
              <ArrowRight className="h-4 w-4" />
            </button>
