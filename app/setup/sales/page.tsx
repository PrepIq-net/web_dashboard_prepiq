      ...
      <div className="w-full max-w-lg">
        ...
        <div className="flex items-center gap-2 mb-10">
          ...
          <span className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#A8821F]">
            {t("setup.common.step", { step: 2 })} — {t("setup.common.salesData")}
          </span>
        </div>
        ...
        <div className="space-y-3 mb-8">
          ...
          <OptionCard
            ...
            detail={
              <p className="text-[11px] text-[#5A5A60] mt-2 font-mono">
                {t("setup.sales.supportedFormats")}
              </p>
            }
          />
          ...
          <OptionCard
            ...
            title={t("setup.common.skipForNow")}
        ...
        >
          {selected === "skip" ? t("setup.sales.skipButton") : t("setup.common.continue")}
