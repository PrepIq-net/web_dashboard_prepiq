  ...
  return (
    ...
    >
      <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#A8821F]">
        {t("workspace.empty.branch.eyebrow")}
      </p>
      <h1
      ...
      >
        {t("workspace.empty.branch.title")}
      </h1>
      <p className="mt-3 max-w-3xl text-[14px] leading-[22px] text-[#8E8E93]">
        {t("workspace.empty.branch.description")}
      </p>
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        <div className="rounded-[10px] border border-[#2E2E33] bg-[#232327] p-4">
          <div className="flex items-center gap-2 text-[#C7C7CC]">
            ...
            <p className="text-[13px] font-semibold">{t("workspace.empty.branch.step1Title")}</p>
          </div>
          <p className="mt-2 text-[12px] text-[#8E8E93]">
            {t("workspace.empty.branch.step1Desc")}
          </p>
        </div>
        <div className="rounded-[10px] border border-[#2E2E33] bg-[#232327] p-4">
          <div className="flex items-center gap-2 text-[#C7C7CC]">
            <DatabaseScript className="h-4 w-4 text-[#A8821F]" />
            <p className="text-[13px] font-semibold">{t("workspace.empty.branch.step2Title")}</p>
          </div>
          <p className="mt-2 text-[12px] text-[#8E8E93]">
            {t("workspace.empty.branch.step2Desc")}
          </p>
        </div>
      </div>
      ...
      <div className="mt-7">
        ...
        >
          {t("workspace.empty.branch.button")}
